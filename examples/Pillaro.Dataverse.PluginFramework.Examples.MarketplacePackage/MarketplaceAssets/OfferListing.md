...
The draft offer in Partner Center is `pillaro-dataverse-plugin-framework`. Offer setup,
Properties, Availability and Technical configuration are complete and saved from the values
below. Offer listing is still short of its privacy policy link, its two contacts, the logo
and the screenshots; Supplemental content is still short of the key usage scenario PDF.
