...
namespace Pillaro.Dataverse.PluginFramework.Examples.Logic
{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<Pillaro.Dataverse.PluginFramework.Examples.Logic.Task> Account_Tasks
		{
			get
			{
				return this.GetRelatedEntities<Pillaro.Dataverse.PluginFramework.Examples.Logic.Task>("Account_Tasks", null);
			}
			set
			{
				this.SetRelatedEntities<Pillaro.Dataverse.PluginFramework.Examples.Logic.Task>("Account_Tasks", null, value);
			}
		}
