...
| File | Use when |
|---|---|
| `PillaroFramework_1_0_0_3_managed.zip` | You want to install the framework into an environment. This is the recommended option for most users. |
| `PillaroFramework_1_0_0_3.zip` | You need the unmanaged solution for development or inspection. |
...
- Import `PillaroFramework_1_0_0_3_managed.zip` into Dataverse.
